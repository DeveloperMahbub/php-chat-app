...
<body>
                ...
                <div class="input-group searchbox">
                    <div class="input-group-btn">
                        <center><a href="include/find_friends.php"><button class="btn btn-default search-icon"
                                    name="search_user" type="submit">View user</button></a></center>
            ...
            <div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
                                    ...
                                    echo "
                                        <li>
                                            <div class='rightside-right-chat'>
                                                <span><small>$msg_date</small><small>$msg_status</small></span><br><br>
                                                <p>$msg_content</p>
                                            </div>
                                        </li>
                                    ";
                ...
                <div class="row">
                    <div class="col-md-12 right-chat-textbox">
                        <form action="" method="post">
                            <input type="text" name="msg_content" placeholder="Write your mesage..." autocomplete="off" required>
    ...
    <?php
        if(isset($_POST['submit'])){
            ...
            if(strlen($msg) > 100){
                ...
                if (isset($username) && isset($receiver_username)) {
                    header("Location:home.php?user_name=$receiver_username");
                }
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.left-chat').css('height', (height - 90) + 'px');
            $('.right-header-contentChat').css('height', (height - 172) + 'px');
        });
    </script>
</body>
</html>
